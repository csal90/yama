        ...
        <div className="flex items-start justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-lg text-stone-warm">
              Your bookmarked scouting spots and planned collecting trips.
            </p>
          </div>
        </div>

        {/* Tabs */}
        <div className="flex gap-1 bg-sand-light/50 rounded-lg p-1 mb-8 w-fit">
          <button
          ...
          <div>
            {savedSpotData.length === 0 ? (
              <EmptyState
                ...
                description="Explore the map and save promising scouting spots to build your collection wishlist."
          ...
          <div>
            <div className="flex items-center justify-between mb-6">
              <p className="text-sm text-stone-warm">
                Organize your saved spots into scouting trip itineraries.
              </p>
              <Button
                size="sm"
                className="gap-2"
            ...
            {tripPlans.length === 0 && !showNewTrip ? (
              <EmptyState
                ...
                description="Create a trip plan to organize your scouting spots into planned itineraries."
    ...
    <div className="rounded-xl border border-sand/70 bg-white p-5 transition-shadow hover:shadow-sm">
      ...
      {tripSpots.length > 0 ? (
        ...
        <div className="rounded-lg border border-dashed border-sand bg-sand-light/20 p-6 text-center">
          <p className="text-sm text-stone-warm">
            No spots added yet. Save spots from the map and add them here.
          </p>
        </div>
      )}
    </div>
